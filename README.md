...
### v1.1 — peer-review revision package
...
- Added permutation feature-importance outputs.
- Added paired ranking effect sizes and bootstrap confidence intervals.
- Added aligned Table S7/Table S17 group-ranking metrics.
- Corrected uncertainty table values for the revised ranking metrics.
- Added descriptor-rationale, alternative-target, and AI-ready reporting checklist tables.
- Added revised Figure 5 and simplified graphical abstract.
